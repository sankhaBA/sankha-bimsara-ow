            ...
            <div className="flex items-start justify-between gap-3 mb-4">
              <div className="flex items-start gap-2">
                ...
                {project.status === "Completed" && (
                  <svg className="w-6 h-6 text-[var(--gh-success-fg)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                )}
                {project.status === "In Progress" && (
                  <svg className="w-6 h-6 text-[var(--gh-accent-fg)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {project.isWinner && project.winnerBadge && (
                <div className="flex-shrink-0">
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-amber-800 to-orange-900 rounded-full shadow-lg">
              ...
              <div className="flex flex-wrap gap-2 pt-4 border-t border-[var(--gh-border-default)]">
                {project.links.map((link, idx) => (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-[var(--gh-accent-emphasis)] text-white rounded hover:bg-[var(--gh-accent-fg)] transition-colors"
                  >
                    {link.title}
